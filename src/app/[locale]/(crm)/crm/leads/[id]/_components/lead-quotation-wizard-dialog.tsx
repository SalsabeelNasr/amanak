...
export function LeadQuotationWizardDialog({
  ...
  const flightCountryBand = useMemo(
    () => inferCountryBandFromCountry(lead.patientCountry ?? ""),
    [lead.patientCountry],
  );
  ...
  }, [currentStep, doctorId, hospitalId, lead.clientType, steps.length, t]);
      ...
      >
        ...
        <DialogFooter className="border-t border-border pt-4">
          <div className="flex w-full items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              {(currentStep === "doctorHospital" && lead.clientType === "b2c") ||
